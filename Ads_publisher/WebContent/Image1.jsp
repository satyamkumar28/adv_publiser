...
int key=start;
int imgid1=hm.get(key);

info.setPopupimgid(imgid1);
info.setImgid1(imgid1);
session.setAttribute("info", info);


Connection con=DBmanager.getconnection();
ResultSet rs=DBad.getadsresultset(imgid1);
while(rs.next())
{
...
%>
	...
	<img src='<%=path%>' height='180' width='180' onclick="MyWindow=window.open('http://localhost:8070/Ads_publisher/PopUp.jsp?popid=<%=imgid1%>','MyWindow');return false;">
<font size=3>
