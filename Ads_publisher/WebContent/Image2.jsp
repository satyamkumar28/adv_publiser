...
int key=start+1;
int imgid2=hm.get(key);

info.setPopupimgid(imgid2);
info.setImgid2(imgid2);
session.setAttribute("info", info);


Connection con=DBmanager.getconnection();
ResultSet rs=DBad.getadsresultset(imgid2);
while(rs.next())
{
...
%>
	...
	<img src='<%=path%>' height='180' width='180' onclick="MyWindow=window.open('http://localhost:8070/Ads_publisher/PopUp.jsp?popid=<%=imgid2%>','MyWindow');return false;">
<font size=3>
